function [outImgName, outImgPath, outImg] = LoadCropImg(imgFolder, ...
    imgDir, outType, varargin)
%LOADCROPIMG Load and image and crop to size
%   Load an image from a file and crop it according to size.
%   INPUT:
%   imgFolder: The images folder.
...
[outImgName, outImgPath] = uigetfile(fullfile(imgFolder,['\*.' imgType]), ...
    dispTxt);
